...
File1 ="/Users/laurel/Desktop/Research/CppHenyeyCode/misc_debugging_records/Sept_13_inverseS_debug_from_Peter_vals.txt"
label1 = 'Peter'

File2 ="/Users/laurel/Desktop/Research/CppHenyeyCode/misc_debugging_records/Sept_13_inverseS_debug_from_Helena_vals.txt"
label2 = 'Helena'
...
for irow in row:
    ...
    plt.subplots_adjust(left=0.1, right=0.9, top=0.9, bottom=0.25)
    plt.suptitle('Inverse S matrix values comparisons')
