...
1) README               This text file.  Basic information on the tables.
...
4) RHO_CRIT             Coexistence curve of the H plasma phase transition (PPT)
5) H_TAB_P1.A           Small table for the EOS near the plasma phase transition 
                        (PPT) of hydrogen: Phase 1 (low density phase)  
                        3.54 < log T < 4.82
6) H_TAB_P2.A           Small table for the EOS near the plasma phase transition 
                        (PPT) of hydrogen: Phase 2 (high density phase)  
                        3.54 < log T < 4.82
7) HE_TAB_I.A           Interpolated helium EOS table  2.10 < log T < 7.06
...
Didier Saumon
Appled Physics Division
X-1 Applied Science and Methods Development
